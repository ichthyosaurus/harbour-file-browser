...
property color highlightColor:Theme.colorScheme===Theme.LightOnDark?Theme.highlightColor:Qt.lighter(Theme.highlightColor,2)
readonly property color _activeColor:highlighted?icon.highlightColor:icon.color
width:size+2*grow
height:width
icon{width:size
height:size
