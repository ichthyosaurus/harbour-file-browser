...
# This project moved to [Codeberg](https://codeberg.org/ichthyosaurus/harbour-file-browser)

> [!WARNING]
> **Development of File Browser has moved to
> [Codeberg](https://codeberg.org/ichthyosaurus/harbour-file-browser).
...
See [below](#acknowledgements) for this project's history.
